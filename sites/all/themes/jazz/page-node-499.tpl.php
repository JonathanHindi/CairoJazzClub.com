		...
		<div id="main_content_script" style="float:left;">
			...
			?>
				<div class="views-row views-row-1 views-row-odd views-row-first views-row-last">
					<div class="views-field views-field-field-cd-image-fid"> 
						<span class="field-content"><a rel="imagefield-fancybox-all" class="imagefield-fancybox" title="The Clown - Wyvern" href="http://www.cairojazzclub.com/<?php print $nodee->field_cd_image['0']['filepath']; ?>"><img width="100" height="100" class="imagecache imagecache-node-gallery-thumbnail" title="The Clown - Wyvern" alt="The Clown - Wyvern" src="http://www.cairojazzclub.com/<?php print $nodee->field_cd_image['0']['filepath']; ?>"></a></span>
					</div>  
					<div class="views-field views-field-title">        
						<span class="field-content"><?php print $nodee->title; ?></span>  
					</div>  
					<div class="views-field views-field-field-cd-artist-name-nid">    
						<span class="views-label views-label-field-cd-artist-name-nid">More about </span>
						<span class="field-content"><a href="http://www.cairojazzclub.com/node/<?php echo $art_id; ?>"><?php echo $artist_node->title; ?></a></span>
					</div>  
					<div class="views-field views-field-field-cd-price-value">
						<span class="field-content"><?php print $nodee->field_cd_price['0']['value']; ?>L.E</span>
					</div>  
					<div class="views-field views-field-body">    
						<span class="views-label views-label-body">Album review: </span>    
						<div class="field-content"><p><?php print $nodee->body; ?></p></div>
					</div>  
				</div>
